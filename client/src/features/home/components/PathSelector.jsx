      ...
      <div className="relative z-10 w-full max-w-[1095px] flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          <h2 className="text-[32px] font-bold mb-2 tracking-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#ffffff] to-[#808080]">Choose your path</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-gradient-start via-gradient-mid to-gradient-end">We handle the rest!</span>
          </h2>
            ...
            >
              ...
              >
                ...
                <Link 
                  ...
                  className="px-8 py-2.5 w-auto bg-gradient-to-r from-gradient-start via-gradient-mid to-gradient-end rounded-full text-white text-sm font-bold flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(255,63,180,0.3)] hover:shadow-[0_0_30px_rgba(255,63,180,0.5)] transition-shadow"
                >
