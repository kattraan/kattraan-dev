...
const InformationTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/InformationTab'));
const CurriculumTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/CurriculumTab'));
const LiveSessionsTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/LiveSessionsTab'));
const DripTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/DripTab'));
const ReportTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/ReportTab'));
const CommentsTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/CommentsTab'));
const QnATab = lazy(() => import('@/features/instructor/components/course-editor/tabs/QnATab'));
const AssignmentResponsesTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/AssignmentResponsesTab'));
const ReviewsTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/ReviewsTab'));
const ChatBotAnalyticsTab = lazy(() => import('@/features/instructor/components/course-editor/tabs/ChatBotAnalyticsTab'));
...
const EditorTabPanels = React.memo(function EditorTabPanels() {
  ...
  return (
    <div className="w-full flex-1 min-h-0 flex flex-col min-w-0">
      ...
      {activeTab === 'Comments' && (
        <CommentsTab activeCommentStatus={activeCommentStatus} setActiveCommentStatus={setActiveCommentStatus} />
      )}
