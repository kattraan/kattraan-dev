...
const InstructorSidebar = ({ isCollapsed, setIsCollapsed }) => {
    ...
    const navItems = [
        { label: 'Overview', icon: LayoutDashboard, path: ROUTES.INSTRUCTOR_DASHBOARD, exact: true },
    ...
    return (
        <aside className={`${isCollapsed ? 'w-20' : 'w-72'} bg-white/60 dark:bg-[#0c091a]/60 backdrop-blur-3xl border-r border-gray-200 dark:border-white/5 transition-all duration-300 flex flex-col z-50 sticky top-0 h-screen`}>
            {/* Logo Area */}
