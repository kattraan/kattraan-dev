...
const CurriculumTab = ({
  ...
  const handleSaveChapterEdit = (sectionId) => {
    if (editingChapterTitle.trim() && editingChapterId) {
      onUpdateChapter(sectionId, editingChapterId, {
                          ...
                          <span
                            className={`font-semibold text-[14px] truncate transition-colors duration-200 cursor-text select-none ${
                              isSectionOpen
                                ...
                                : "text-gray-700 dark:text-white/70 group-hover/section:text-gray-900 dark:group-hover/section:text-white"
                            }`}
                            onClick={(e) => {
                              e.stopPropagation();
                      ...
                      return (
                        <div
                          ...
                          className={`relative rounded-xl transition-all duration-250 group/chapter ${
                            ...
                            draggingChapterInfo?.sectionId ===
                              (section._id || section.id).toString()
                                ...
                                {isSelectionMode ? (
                                  <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                                    <div className="flex items-center justify-between mb-5 px-0.5">
                                      <div>
                                        ...
                                        <p className="text-[11px] text-gray-400 dark:text-white/30 mt-0.5">
                                          Select the main type of content for
                                          this chapter
                                        </p>
                                      </div>
                                      <button
                                    ...
                                    <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-2">
                                      ...
                                      <CurriculumContentTypeCard
                                        onClick={() =>
                                          onTriggerContent("document", chId)
                                        }
                                        Icon={FileText}
                                        color="bg-[#00D285]"
                                        label="Document"
                                      ...
                                      <CurriculumContentTypeCard
                                        onClick={() =>
                                          onTriggerContent("assignment", chId)
                                        }
                                        Icon={ClipboardList}
                                        color="bg-[#0D9488]"
                                        label="Assignment"
                      ...
                      <div className="mx-0.5 mt-1 p-3.5 bg-white dark:bg-[#272727] rounded-xl border border-primary-pink/20 dark:border-primary-pink/15 shadow-sm transition-colors duration-300 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        <div className="flex items-center gap-2.5">
                          <input
                            ...
                            onKeyDown={(e) =>
                              e.key === "Enter" &&
                              handleSaveChapter(section._id || section.id)
                            }
                          />
                          <button
