...
const Dashboard = lazy(() => import('../pages/dashboard/InstructorDashboardPage'));
const MyCourses = lazy(() => import('../pages/instructor/courses/MyCoursesPage'));
const CreateCourse = lazy(() => import('../pages/instructor/courses/CourseEditorPage'));
    ...
    <Routes>
      <Route element={<ProtectedRoute allowedRoles={['instructor']} />}>
        ...
        <Route element={<DashboardLayout role={DASHBOARD_ROLES.INSTRUCTOR} />}>
          ...
          <Route path="learners" element={<Suspense fallback={null}><Learners /></Suspense>} />
