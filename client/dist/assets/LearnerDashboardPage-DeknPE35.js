...
to {
  ...
  animation: ${Oe} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,He=({toast:e})=>{let{icon:r,type:a,iconTheme:i}=e;return r!==void 0?typeof r=="string"?p.createElement(Te,null,r):r:a==="blank"?null:p.createElement(Be,null,p.createElement(Me,{...i}),a!=="loading"&&p.createElement(Re,null,a==="error"?p.createElement(Ee,{...i}):p.createElement(Pe,{...i})))},qe=e=>`
